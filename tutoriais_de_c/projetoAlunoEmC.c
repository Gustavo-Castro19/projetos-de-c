...
int main() {
    ...
    if(Presenca<75) printf("reprovado por falta\n");//a condicional para aprovação do aluno exige nota de no mínimo 7 e presença de no minimo 75% das aulas.
    else if(Media>=7) printf("aprovado!!!\n");
    else printf("reprovado por estar abaixo da media\n");
